...
export type Asset = Node & {
  ...
  id: Scalars['ID'];
  imageTechnology: Array<Technology>;
  /** System Locale field */
  locale: Locale;
...
/** Asset system model */
export type AssetImageTechnologyArgs = {
...
export type ProjectCreateInput = {
  ...
  title: Scalars['String'];
  tools?: InputMaybe<Array<Scalars['String']>>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type ProjectManyWhereInput = {
  ...
  tools_contains_all?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  tools_contains_none?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  tools_contains_some?: InputMaybe<Array<Scalars['String']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  tools_not?: InputMaybe<Array<Scalars['String']>>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type ScheduledOperationAffectedDocument = Asset | Project | Technology | Tool;
...
export type TechnologyImageArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
...
export type ProjectsListQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', id: string, title: string, description: string, github?: string | null, tools: Array<string> }> };
 ...
 * });
 */
export function useTechnologiesListQuery(baseOptions?: Apollo.QueryHookOptions<TechnologiesListQuery, TechnologiesListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TechnologiesListQuery, TechnologiesListQueryVariables>(TechnologiesListDocument, options);
      }
export function useTechnologiesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TechnologiesListQuery, TechnologiesListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TechnologiesListQuery, TechnologiesListQueryVariables>(TechnologiesListDocument, options);
        }
